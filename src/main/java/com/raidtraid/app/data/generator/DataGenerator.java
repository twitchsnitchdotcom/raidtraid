package com.raidtraid.app.data.generator;
...
public class DataGenerator {
    ...
    public CommandLineRunner loadData(ContactRepository contactRepository, CompanyRepository companyRepository,
        ...
        return args -> {
            ...
            logger.info("... generating 10 Contact entities...");
            ...
            List<Contact> contacts = contactGenerator.create(10, seed).stream().peek(contact -> {
